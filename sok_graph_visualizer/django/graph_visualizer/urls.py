...
urlpatterns = [
    ...
    path('workspace/<str:workspace_id>/', views.load_workspace, name='load_workspace'),
    path('render/', views.render_graph_view, name='render_graph'),

    # API endpoints
    path('api/workspaces/', views.list_workspaces, name='api_list_workspaces'),
    path('api/workspace/<str:workspace_id>', views.delete_workspace, name='api_delete_workspace'),
    path('api/workspace/<str:workspace_id>/get', views.get_workspace, name='api_get_workspace'),
    path('api/workspace/<str:workspace_id>/activate', views.activate_workspace, name='api_activate_workspace'),
